...
const pipeline_colour = ["match", substance, ["gas", "natural_gas", "cng"], colour_gas, colour_oil]

const substance_operator = [
  "concat",
  ["get", "operator"],
  ["case", ["all", ["!=", substance, ""], ["!=", ["get", "operator"], ""]], ["concat", " (", substance, ")"], substance]
]

const layers = [
  {
    zorder: 0,
    id: "petroleum_pipeline_case_oil",
    type: "line",
    filter: ["==", ["get", "substance"], "oil"],
    source: "openinframap",
    minzoom: 7,
  ...
  {
    zorder: 0,
    id: "petroleum_pipeline_case_gas",
    type: "line",
    filter: ["==", ["get", "substance"], "gas"],
    source: "openinframap",
    minzoom: 7,
    "source-layer": "petroleum_pipeline",
    paint: {
  ...
  {
    zorder: 500,
    id: "petroleum_pipeline_label_gas",
    type: "symbol",
    filter: ["==", ["get", "substance"], "gas"],
    source: "openinframap",
    "source-layer": "petroleum_pipeline",
  ...
  {
    zorder: 500,
    id: "petroleum_pipeline_label_oil",
    type: "symbol",
    filter: ["==", ["get", "substance"], "oil"],
    source: "openinframap",
    "source-layer": "petroleum_pipeline",
